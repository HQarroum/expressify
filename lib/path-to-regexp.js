/**
  * Exporting the `pathToRegexp` module appropriately given
 ...
 (function (name, definition) {
  ...
  window.isarray = Array.isArray || function (arr) {
  ...
  window.tokensToFunction = tokensToFunction
  window.tokensToRegExp = tokensToRegExp*/
