 ...
 (function (name, definition) {
    if (typeof define === 'function' && define.amd) {
        ...
        var gl       = this;
        var instance = definition(gl.Chain, gl.Request, gl.Response, gl.ResourceManager, gl.pathToRegexp);
        var old      = gl[name];
 ...
 })('ExpressifyServer', function (Chain, Request, Response, ResourceManager, pathToRegexp) {
